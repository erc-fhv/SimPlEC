"""Test to compare time discrete vs event discrete simulation results"""
...
def test_compare_time_disc_vs_event_disc():
    """
    Test to compare time discrete vs event discrete simulation results
    for a simple building-heatpump-controller scenario.
    """
    ...
    sim_event.add_model(building,   watch_values=['T_room1', 'T_room2', 'T_amb', 'apparent_zenith',
        'dhi', 'ghi']  )
    ...
    sim_event.connect(weather, building, ('T_air', 'T_amb'), 'apparent_zenith', 'azimuth', 'dni',
        'dhi', 'ghi')
    ...
    sim_event.connect(building, heatpump, ('T_room1', 'T_sink'), time_shifted=True,
        init_values={'T_room1': 21})
    sim_event.connect(building, controller, ('T_room1', 'T_is'), time_shifted=True,
       init_values={'T_room1': 21})
    ...
    sim_discrete.add_model(building,   watch_values=['T_room1', 'T_room2', 'T_amb',
        'apparent_zenith', 'dhi', 'ghi']  )
    ...
    sim_discrete.connect(weather, building, ('T_air', 'T_amb'), 'apparent_zenith', 'azimuth',
        'dni', 'dhi', 'ghi')
    ...
    sim_discrete.connect(building, heatpump, ('T_room1', 'T_sink'), time_shifted=True,
        init_values={'T_room1': 21})
    sim_discrete.connect(building, controller, ('T_room1', 'T_is'), time_shifted=True,
        init_values={'T_room1': 21})
    ...
    assert df_event.compare(df_discrete).empty, \
        'Time discrete simulation differs from event discrete!'
